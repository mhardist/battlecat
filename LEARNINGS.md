# Learnings — Battle Cat AI Build

Technical lessons learned during the development and deployment of Battle Cat AI. These are real issues encountered during production deployment, not hypothetical concerns.
